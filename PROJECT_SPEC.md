...
스리랑카에서 수입한 다양한 상품들을 전시하는 온라인 쇼룸 플랫폼입니다. 사용자는 상품품을 둘러보고 관심 상품을 체크하여 판매자에게 구매 주문을 할 수 있습니다. 직접 판매 기능은 제공하지 않으며, 상품 전시 및 주문 연결에 중점을 둡니다.
...
- 🔍 제품 목록 조회 및 검색
- 📂 카테고리별 상품 분류
- 🛒 위시리스트 시스템 (상품 담기 및 주문 기능)
- 📞 판매자 연락처 연결 기능 (예정)
- 📧 이메일 알림 및 주문 발송 (Nodemailer)
...
- **기능**: 상품 담기/제거, 선택 상품 목록 관리, 이메일 주문 발송
- **기술**: Zustand (상태 관리), React Hook Form, Nodemailer, Zod (유효성 검사)
- **구현**: `components/wishlist/`, `app/wishlist/`, 주문 폼 생성, 이메일 발송 API 구축
