...
import { Heart, MessageCircle, Minus, Plus, Trash2 } from 'lucide-react'
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1">
                <Button
                  ...
                  className="text-red-600 hover:text-red-700 text-xs px-2 mr-1"
                >
                  <Trash2 className="h-3 w-3" />
                  {isMobile ? `삭제 (${selectedCount})` : `선택 삭제 (${selectedCount})`}
                </Button>
                <Button
                  size="sm"
                ...
                >
                  ...
                  {isMobile ? `상품 주문 (${selectedCount})` : `선택 상품 주문 (${selectedCount})`}
                </Button>
              </div>
            </div>
          </CardContent>
